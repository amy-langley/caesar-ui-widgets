...
import JsonBuilder from '../components/json_builder';
...
storiesOf('JsonBuilder', module).add('empty', () => <JsonBuilder initialValue="" /> );
storiesOf('JsonBuilder', module).add('simple', () => <JsonBuilder initialValue='{"foo": "bar"}' /> );
storiesOf('JsonBuilder', module).add('complex', () => <JsonBuilder initialValue='{"foo": "bar", "baz": 3, "glarch": { "foo": "bar" }, "x": "y"}' /> );